...
logger.setLevel(10)
logger.addHandler(AzureLogHandler(connection_string='InstrumentationKey=c9424add-f0c6-4443-a299-717b79367f21'))

headers = {
    "Ocp-Apim-Subscription-Key": "8ab9855898c54c40a995b8f5bf03c8e2",
